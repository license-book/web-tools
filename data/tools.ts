...
export const tools: ToolDefinition[] = [
  ...
  { slug:'pdf-to-image', title:'PDF 이미지 변환', shortDescription:'PDF 페이지를 PNG 또는 JPG 이미지로 변환합니다.', description:'PDF 파일을 서버에 업로드하지 않고 브라우저에서 원하는 페이지를 PNG 또는 JPG 이미지로 변환하는 무료 도구입니다.', category:'pdf', keywords:['PDF 이미지 변환','PDF JPG','PDF PNG','PDF 사진 변환','PDF to image'], featured:true, badge:'사용 가능' },
