...
export const tools: ToolDefinition[] = [
  ...
  {slug:'json-yaml-converter',title:'JSON ↔ YAML 변환',shortDescription:'JSON과 일반적인 YAML 구조를 서로 변환합니다.',description:'JSON 데이터를 YAML로 변환하거나 일반적인 YAML 객체·배열 구조를 JSON으로 바꾸는 브라우저 기반 개발 도구입니다.',category:'developer',keywords:['JSON YAML 변환','YAML JSON','yaml converter','json to yaml','yaml to json'],featured:true,badge:'사용 가능'},
  {slug:'json-csv-converter',title:'JSON ↔ CSV 변환',shortDescription:'객체 배열 JSON과 CSV 데이터를 서로 변환합니다.',description:'JSON 객체 배열을 CSV로 변환하거나 헤더가 있는 CSV를 JSON 배열로 변환하고 파일로 저장하는 무료 개발 도구입니다.',category:'developer',keywords:['JSON CSV 변환','CSV JSON','json to csv','csv to json','CSV converter'],featured:true,badge:'사용 가능'},
  {slug:'diff-checker',title:'텍스트 Diff 비교',shortDescription:'두 텍스트나 코드의 추가·삭제 줄을 비교합니다.',description:'원본과 변경본을 라인 단위로 비교해 추가·삭제된 내용을 브라우저에서 확인하는 무료 개발 도구입니다.',category:'developer',keywords:['diff checker','텍스트 비교','코드 비교','diff compare','문자열 비교'],featured:true,badge:'사용 가능'},
  {slug:'sql-formatter',title:'SQL Formatter',shortDescription:'SQL을 읽기 좋게 정리하거나 한 줄로 압축합니다.',description:'일반적인 SQL 키워드와 구문을 빠르게 정렬하거나 불필요한 공백을 줄이는 브라우저 기반 개발 도구입니다.',category:'developer',keywords:['SQL Formatter','SQL 정리','SQL beautify','SQL minify','SQL formatter online'],featured:true,badge:'사용 가능'},
  {slug:'cron-tool',title:'Cron 표현식 생성·해석',shortDescription:'5필드 Cron 표현식을 만들고 의미를 빠르게 확인합니다.',description:'분·시·일·월·요일 값을 조합해 표준 5필드 Cron 표현식을 만들고 자주 쓰는 스케줄 프리셋과 간단한 해석을 제공하는 개발 도구입니다.',category:'developer',keywords:['Cron 생성기','Cron 해석','crontab','cron expression','cron generator'],featured:true,badge:'사용 가능'},
];
